...
const StatCard: React.FC<{
  ...
  <div className="bg-white/40 backdrop-blur-2xl rounded-2xl border border-white/20 p-4 shadow-sm hover:shadow-md transition-all duration-300 group">
    <div className="flex items-start justify-between mb-2">
      <div className="w-7 h-7 rounded-lg bg-white/20 flex items-center justify-center text-gray-400 group-hover:bg-red-50/50 group-hover:text-red-500 transition-colors">
        {React.cloneElement(icon as React.ReactElement, { size: 14 })}
      </div>
      <ArrowUpRight size={10} className="text-gray-300 group-hover:text-red-400 transition-colors" />
    </div>
  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-[#F5F5F7] flex flex-col">
      ...
      <header className="h-[52px] bg-white/40 backdrop-blur-3xl border-b border-white/20 flex items-center justify-between px-5 shrink-0 shadow-sm z-50">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gray-800/90 backdrop-blur-md text-white rounded-xl text-[11px] font-bold uppercase tracking-widest hover:bg-blue-600 transition-all shadow-md"
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative">
        ...
        {/* ─── 桌面端侧栏（md 以上显示） ─── */}
        <aside className="hidden md:flex w-[25vw] min-w-[380px] max-w-[480px] h-full flex-col shrink-0 bg-[#F5F5F7]/40 backdrop-blur-3xl border-l border-white/20 overflow-hidden">
          {/* 统计头 */}
        ...
        <div className="fixed inset-0 z-[10000] bg-black/50 backdrop-blur-sm flex items-center justify-center p-6" onClick={() => setShowInquiry(false)}>
          <div className="bg-white rounded-3xl shadow-2xl max-w-lg w-full p-8" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-6">
              <div>
                <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block px-1">
                  {lang === 'cn' ? '公司名称 / 项目名称' : 'Company / Project Name'}
                </label>
                <input className="w-full px-5 py-3.5 bg-gray-50 rounded-2xl border border-gray-100 text-sm font-medium focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/5 transition-all" placeholder={lang === 'cn' ? '例：小龙坎柏林分店' : 'e.g., Xiaolongkan Berlin'} />
              </div>
              <div className="grid grid-cols-2 gap-5">
                <div>
                  ...
                  <input className="w-full px-5 py-3.5 bg-gray-50 rounded-2xl border border-gray-100 text-sm font-medium focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/5 transition-all" />
                </div>
                <div>
                  <label className="text-[11px] font-bold text-gray-500 uppercase tracking-widest mb-1.5 block px-1">Email / WhatsApp</label>
                  <input className="w-full px-5 py-3.5 bg-gray-50 rounded-2xl border border-gray-100 text-sm font-medium focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/5 transition-all" />
                </div>
              </div>
              <div>
                ...
                <textarea className="w-full px-5 py-3.5 bg-gray-50 rounded-2xl border border-gray-100 text-sm font-medium focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/5 transition-all resize-none h-28" placeholder={lang === 'cn' ? '您的需求描述...' : 'Describe your needs...'} />
              </div>
            </div>
